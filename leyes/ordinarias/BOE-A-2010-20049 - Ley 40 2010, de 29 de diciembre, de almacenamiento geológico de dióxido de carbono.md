...
- Identificador BOE: `BOE-A-2010-20049`
- Texto consolidado (informativo, sin valor jurídico oficial): https://www.boe.es/buscar/act.php?id=BOE-A-2010-20049
...
a) Llevar a cabo trabajos de investigación para almacenamiento de CO2 sin contar con un permiso de investigación con arreglo a esta ley.
...
c) ingeniería de los depósitos o estructura geológica del lugar del almacenamiento (por ejemplo, cálculos volumétricos del volumen de poro para la inyección de CO2 y la capacidad final de almacenamiento);
...
a) Zonas que circundan el complejo de almacenamiento susceptibles de estar afectadas por el almacenamiento de CO2 en el lugar de almacenamiento;
...
e) proximidad de la fuente o fuentes potenciales de CO2 (en particular, estimación de la masa potencial total de CO2 económicamente disponible para el almacenamiento) y redes de transporte adecuadas.
...
c) procesos reactivos (es decir, cómo se incorporan al modelo las reacciones in situ del CO2 inyectado con los minerales);
d) simulador de depósito utilizado (podría ser necesario recurrir a varias simulaciones para validar ciertas conclusiones);
e) simulaciones a corto y a largo plazo (para determinar el destino y el comportamiento futuro del CO2 a lo largo de décadas y milenios, así como el índice de disolución del CO2 en el agua).
...
c) naturaleza del flujo de CO2 en la estructura geológica del lugar del almacenamiento, incluido el comportamiento de las diferentes fases;
...
c) presión y temperatura del CO2 en las cabezas de pozo de inyección (con objeto de determinar el flujo másico);
...
a) Tecnologías que permitan detectar la presencia, la localización y las vías de migración de CO2 en las formaciones subterráneas y en la superficie;
